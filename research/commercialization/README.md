...
- [`lookie-link-publish-api-cli-public-link-evaluation-2026-06-01.md`](lookie-link-publish-api-cli-public-link-evaluation-2026-06-01.md) — Evaluation of whether Lookie-Link should add a publish API, CLI, and bounded public-share with expiry/password governance. Synthesizes the publish-primitive recommendations from the three prior commercialization docs, answers the six questions from the canonical content and publish API proposal, connects back to GitHub URL-to-local-path translation / public-internet hosting work / token-scoped access grants, and proposes a three-phase plan with concrete child issues. Recommendation: ship phase 1 (publish primitive) as a limited prototype in 2–3 weeks; defer phase 3 (public-share) until real demand or paired Pangolin exposure.
