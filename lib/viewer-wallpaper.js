...
function viewerWallpaperRuntime() {
  ...
  opacity.addEventListener('input', function () { state.opacity = Number(opacity.value); save(); apply(); });
  blur.addEventListener('input', function () { state.blur = Number(blur.value); save(); apply(); });
