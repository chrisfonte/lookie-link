...
const CORE_ROUTES = [
  ...
  ['get', '/api/managed-repos/:repo/changes', 'managed-repos', 'Files changed since a timestamp', { query: [q('since', 'Numeric Unix timestamp.', { type: 'number' }), q('maxEntries', 'Entry bound.', { type: 'integer' })], json: ref('Ok'), capability: 'managedRepos', endpointKey: 'managedChanges' }],
  ...
  ['get', '/api/search', 'managed-repos', 'Search managed repositories', { query: [q('q', 'Search text.', { type: 'string' }, true), q('scope', 'Repeatable repo or repo/path scope.'), q('limit', 'Result bound.', { type: 'integer' }), q('maxEntries', 'Candidate bound.', { type: 'integer' })], json: ref('Ok'), capability: 'search', endpointKey: 'search' }],
  ['get', '/api/search/suggest', 'managed-repos', 'Path suggestions', { query: [q('q', 'Prefix text.', { type: 'string' }, true), q('scope', 'Repeatable scope.'), q('limit', 'Result bound.', { type: 'integer' }), q('maxEntries', 'Candidate bound.', { type: 'integer' })], json: ref('Ok'), capability: 'search', endpointKey: 'searchSuggest' }],
