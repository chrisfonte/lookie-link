...
const FORMS_ROUTES = [
  ...
  ['post', '/api/forms/templates', 'forms', 'Create a draft template', { auth: FORMS_WRITE, body: obj({ id: str(), title: str(), fields: { type: 'array', items: { type: 'object' } }, destinationId: str() }, ['id', 'title', 'fields']), json: ref('Ok'), status: '201', capability: 'forms', endpointKey: 'formsTemplates' }],
  ['get', '/api/forms/templates/:templateId', 'forms', 'Read template management metadata', { json: ref('Ok'), capability: 'forms' }],
  ['patch', '/api/forms/templates/:templateId', 'forms', 'Revise a draft template', { auth: FORMS_WRITE, body: obj({ revision: { type: 'integer', minimum: 1 }, title: str(), fields: { type: 'array', items: { type: 'object' } } }, ['revision']), json: ref('Ok'), capability: 'forms' }],
  ['delete', '/api/forms/templates/:templateId', 'forms', 'Delete a draft template', { auth: FORMS_WRITE, json: ref('Ok'), capability: 'forms' }],
  ['post', '/api/forms/templates/:templateId/publish', 'forms', 'Publish the next immutable version', { auth: FORMS_WRITE, body: obj({ revision: { type: 'integer', minimum: 1 } }), json: ref('Ok'), capability: 'forms' }],
  ['post', '/api/forms/templates/:templateId/clone', 'forms', 'Clone a template', { auth: FORMS_WRITE, body: obj({ id: str(), title: str() }), json: ref('Ok'), status: '201', capability: 'forms' }],
  ['post', '/api/forms/templates/:templateId/archive', 'forms', 'Archive a template', { auth: FORMS_WRITE, body: obj({ revision: { type: 'integer', minimum: 1 } }), json: ref('Ok'), capability: 'forms' }],
  ['post', '/api/forms/templates/:templateId/restore', 'forms', 'Restore an archived template', { auth: FORMS_WRITE, body: obj({ revision: { type: 'integer', minimum: 1 } }), json: ref('Ok'), capability: 'forms' }],
  ['post', '/api/forms/:templateId/submissions', 'forms', 'Submit an entry', { auth: FORMS_WRITE, body: obj({ values: { type: 'object' }, idempotencyKey: str() }, ['values']), json: ref('Ok'), status: '201', capability: 'forms', endpointKey: 'formsSubmissions' }],
