...
async function searchManagedRepos(options) {
  ...
  return { results, count: results.length, truncated, skippedRepos: skipped, reposSearched: repos.length, limits: { results: limit, entries: maxEntries, entriesPerRepo: perRepo, fileBytes: MAX_FILE_BYTES, totalBytes: MAX_TOTAL_BYTES, bytesPerRepo } };
}
