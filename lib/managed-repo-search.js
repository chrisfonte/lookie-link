...
async function searchManagedRepos(options) {
  ...
  return { results, count: results.length, truncated, skippedRepos: skipped, limits: { results: limit, entries: maxEntries, fileBytes: MAX_FILE_BYTES, totalBytes: MAX_TOTAL_BYTES } };
}
