...
function addThemeInjection(document, options) {
  ...
  style.textContent = [
    ...
    // viewer page behind it. No-op in content-height mode (the doc never scrolls).
    viewport ? 'html.lookie-embedded-viewport, html.lookie-embedded-viewport body { overscroll-behavior: contain; }' : '',
  ].filter(Boolean).join('\n');
