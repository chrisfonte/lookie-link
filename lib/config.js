...
/**
 * Load lookout.yaml from the project root (next to server.js).
 * Returns null if the file doesn't exist.
 */
function loadConfigFile() {
  // Check env override first, then project root
  const configPath = process.env.LOOKOUT_CONFIG
    ? path.resolve(expandHome(process.env.LOOKOUT_CONFIG))
