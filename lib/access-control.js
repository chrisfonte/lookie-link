...
function authenticateRequest(req, accessConfig, grantStore = null) {
  ...
  if (!token) {
    const grantAccess = grantStore && typeof grantStore.authenticateGrantToken === 'function'
      ? grantStore.authenticateGrantToken(presentedToken, headerToken ? 'header' : 'query', queryToken || null)
      : null;
    if (grantAccess) {
      return grantAccess;
    }
