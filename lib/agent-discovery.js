...
function buildAgentDiscoveryDocument(options) {
  ...
  return {
    schemaVersion: 1,
    name: 'lookie-link',
    // Appearance is an agent-addressable surface: every parameter here can be
    // put on a viewer URL, and every picture id here resolves at imageUrl.
    themes: {
      parameters: {
      ...
      modes: ['dark', 'light'],
      wallpapers: {
        imageUrl: '/wallpaper/{scheme}/{mode}/{id}',
        none: 'none',
