...
function renderDocumentPage({ repo, repoRoot, relativePath, source, parentHref, mtime, size }) {
  ...
  ${isMarkdown ? `<button type="button" class="toc-fab" data-toc-toggle aria-label="Open table of contents" aria-expanded="false" aria-controls="toc-panel">☰</button>
  <div class="toc-overlay" data-toc-overlay aria-hidden="true"></div>
