...
<head>
  ...
  <script>
    (function () {
      ...
      var scheme = localStorage.getItem('lookie-link-color-scheme') || 'slate';
      var mode = localStorage.getItem('lookie-link-theme') || 'dark';
...
function renderDocumentPage({ repo, repoRoot, relativePath, source, parentHref, mtime, size, editHref = null }) {
  ...
  const body = `<div class="viewer-toolbar" role="toolbar" aria-label="Viewer controls">
    ...
    <select class="toolbar-select" data-theme-picker aria-label="Select color theme">
  ...
  <script>
    (function () {
      ...
      function applyColorScheme(scheme) {
        ...
        if (themePickerEl) themePickerEl.value = scheme;
      }
      ...
      var savedScheme = localStorage.getItem('lookie-link-color-scheme');
      applyColorScheme(savedScheme || 'slate');
...
function renderEditPage({
  ...
  const body = `<div class="viewer-toolbar" role="toolbar" aria-label="Editor controls">
